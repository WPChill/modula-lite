		...
		<ul class="collapsible" data-collapsible="accordion">
											...
											<div class="field">
												...
												<?php elseif ( $data["type"] == "color" ) : ?>
													<div class="text">
														...
														<input type="text" size="6" data-default-color="<?php print $data["default"] ?>" name="tg_<?php print $f ?>" value="<?php print $gallery->$f ?>" class='pickColor' />
													</div>
												<?php elseif ( $data["type"] == "PRO_FEATURE" ) : ?>

													<div class="pro-cell">
														<h6>This feature is available only in the PRO version of Modula</h6><br />
														<a class="button button-secondary" href="<?php echo esc_url( admin_url( 'admin.php?page=modula-lite-gallery-upgrade&tab=comparison_table' ) ); ?>" target="_blank">See LITE vs PRO Differences</a>
														<a class="button button-primary" href="https://wp-modula.com/?utm_source=modulalite_inst&utm_medium=banner&utm_campaign=Modula%20Lite#buy" target="_blank"><span class="dashicons dashicons-cart"></span> Get Modula Pro!</a>
													</div>
												...
												<?php elseif ( $data["type"] == "hover-effect" ): ?>
													...
													<div class="text">
														...
														<br />
														<div class="pro-cell">
															<h6>The PRO version of Modula bundles over 12 different hover effects.</h6><br />
															<a class="button button-secondary" href="<?php echo esc_url( admin_url( 'admin.php?page=modula-lite-gallery-upgrade&tab=comparison_table' ) ); ?>" target="_blank">See LITE vs PRO Differences</a>
															<a class="button button-primary" href="https://wp-modula.com/?utm_source=modulalite_inst&utm_medium=banner&utm_campaign=Modula%20Lite#buy" target="_blank"><span class="dashicons dashicons-cart"></span> Get Modula Pro!</a>
														</div>
													</div>
			...
			<li id="images">
				...
				<div class="collapsible-body white lighten-5">
					...
					<div>
						<div class="pro-cell">
							<h6>Add more than 20 images per gallery. Upgrade to PRO</h6><br />
							<a class="button button-secondary" href="<?php echo esc_url( admin_url( 'admin.php?page=modula-lite-gallery-upgrade&tab=comparison_table' ) ); ?>" target="_blank">See LITE vs PRO Differences</a>
							<a class="button button-primary" href="https://wp-modula.com/?utm_source=modulalite_inst&utm_medium=banner&utm_campaign=Modula%20Lite#buy" target="_blank"><span class="dashicons dashicons-cart"></span> Get Modula Pro!</a>
						</div>

						<div class="actions row">
							<label class="label-text row"><?php _e( 'Add Images', 'modula-gallery' ) ?></label>
							<a href="#" class="open-media-panel waves-effect button-bg waves-light btn action"><i class="mdi-image-photo"></i> <?php _e( 'Add images', 'Modula-gallery' ) ?>
							</a>
						</div>
						...
						<div id="image-panel-model" style="display:none">
							...
							<div class="field buttons">
								<a href="#" data-action="cancel" class="action modal-action modal-close waves-effect waves-yellow btn-flat"><i class="mdi-content-reply"></i> <?php _e( 'Cancel', 'modula-gallery' ) ?>
								</a>
								<a href="#" data-action="save" class="action modal-action modal-close waves-effect waves-green btn-flat"><i class="icon icon-save-disk"></i> <?php _e( 'Save', 'modula-gallery' ) ?>
								</a>
							</div>
						</div>
					</div>
