...
<div class="wrap about-wrap modula-wrap">
	<h1><?php echo __( 'Modula - Why you should be upgrading' ); ?></h1>

	<p class="about-text">
		<?php echo __( 'Introducing one of the most powerful gallery system ever made for WordPress. Modula is an exquisite WordPress Gallery Plugin perfectly fit for any needs. We\'ve outlined below the PRO features.' ) ?>
	</p>
