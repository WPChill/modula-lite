		...
		<div class="row ">
			<div class="col s12 m6 l4">
				<div class="card-panel light-green lighten-4">
					...
					<p>
						<?php _e( 'Create your first awesome gallery, click', 'modula-gallery' ) ?>
						<a href="?page=add-modula-lite"><?php _e( 'here', 'modula-gallery' ) ?></a>.
					</p>
				</div>
			</div>
		</div>
					...
					<div class="card <?php print count( $images ) ? "with-image" : "" ?>" id="gallery-<?php print $gid ?>" data-gid="<?php print $gid ?>">
						...
						<div class="data" style="background-image:<?php print $bg ?>">
							...
							<div class="card-action darken-4">
								...
								<a href="?page=modula-lite-edit&galleryId=<?php _e( $gid ); ?>" data-tooltip="Edit gallery" data-position="top" data-delay="10" class="tooltipped waves-effect waves"><i class="mdi mdi-pencil"></i></a>
