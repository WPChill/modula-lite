<div class="feature-section one-col">
	<div class="col">
		...
		<p class="lead-description"><?php echo esc_html__( 'Modula helps <u>casual users</u> create an image gallery in 30s or less.', 'modula-gallery' ); ?></p>
...
<div class="feature-section three-col">
	...
	<div class="col">
		...
		<p><?php echo esc_html__( 'Let visitors filter your gallery items with a single click. Create as many gallery filters as you want. These filters also <u>work in real-time</u> ⭐', 'modula-gallery' ); ?></p>
	</div>
	<div class="col">
	...
	<div class="col">
		...
		<p><?php echo esc_html__( 'Every gallery created with Modula is responsive, mobile ready & retina ready. <b>Your galleries will look beautiful on any device</b>, and any display.', 'modula-gallery' ); ?></p>
	</div>
...
<div class="feature-section three-col">
	...
	<div class="col">
		...
		<p><?php echo esc_html__( 'Modula <b>supports 6 different lightbox scripts</b>: <em>Lightgallery, Lightbox2, PrettyPhoto, Magnific Gallery, SwipeBox and FancyBox</em>. Showcase your image galleries with style.', 'modula-gallery' ); ?></p>
	</div>

	<div class="col">
		<h3><?php echo esc_html__( 'Social Sharing Friendly', 'modula-gallery' ); ?></h3>
		<p><?php echo esc_html__( 'Built-in social sharing buttons that will help you boost your page views. <b>Reach your audience faster and easier</b> with social tools built-in.', 'modula-gallery' ); ?></p>
	</div>

	<div class="col">
		<h3><?php echo esc_html__( 'Multiple Image Hover Effects', 'modula-gallery' ); ?></h3>
		<p><?php echo esc_html__( 'Choose from 12 different hover effects. Pick the ones that best represent your personality. Easily <u>showcase your images in style</u>.', 'modula-gallery' ); ?></p>
	</div>
...
<div class="feature-section two-col">
	<div class="col">
		...
		<p><?php echo esc_html__( 'Modula is built entirely on Material Design principles. Starting with the code layout and finishing up with the smallest animation, Modula screams Material Design from it\'s every pore. <br \/><br \/> Based on the most popular front-end design framework of the century, we\'ve striven to create a modern, flexible and beautiful implementation of Material Design in Modula. <br \/><br \/> We believe you\'ll <b>enjoy it</b>!', 'modula-gallery' ); ?></p>
	</div>
	<div class="col">
...
<div class="changelog">
	<h2><?php
		printf( /* translators: %s: smiling face with smiling eyes emoji */
			esc_html__( 'Even More Plugin Flexibility %s', 'modula-gallery' ), '&#x1F60A' );
		?></h2>
