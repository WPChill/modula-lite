const ModulaIcon = () => {
	return (
		...
		>
          ...
          c-0.2-6.1-0.2-6.1,5.5-4.6c23.8,6.2,47.6,12.5,71.5,18.5c3.9,1,4.2,1.9,2.1,5.4c-23.4,38.5-46.7,77.1-70,115.7
          c-1,1.7-2,3.4-3,5.1C601.7,462.8,602,463,602.3,463.3z"
				/>
				<path
...
const RemoveIcon = () => {
	return (
		<svg
			...
			aria-hidden="true"
		>
			<path d="M19 6H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2zm-1 10H6a1 1 0 0 1 0-2h12a1 1 0 0 1 0 2z" />
		</svg>
	);
}
...
export { ModulaIcon, RemoveIcon, ReplaceIcon, ChevronLeftIcon, ChevronRightIcon, TwitterIcon, FacebookIcon, WhatsAppIcon, PinterestIcon, LinkedInIcon, EmailIcon, ChevronRightFancyIcon };
