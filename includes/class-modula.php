...
class Modula {
	...
	public function admin_scripts( $hook ) {
		...
		if ( 'post-new.php' == $hook || 'post.php' == $hook ) {
			...
			wp_enqueue_script( 'modula-packery', MODULA_URL . 'assets/js/modula-packery.min.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-droppable', 'jquery-ui-resizable', 'jquery-ui-draggable' ), MODULA_LITE_VERSION, true );
