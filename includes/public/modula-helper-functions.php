...
function modula_edit_gallery( $settings ) {
	...
	?> 
	<p> <a href="<?php echo get_site_url() ?>/wp-admin/post.php?post=<?php echo substr( $settings['gallery_id'], -1) ?>&action=edit"> <?php esc_html_e( 'Edit Gallery', 'modula-best-grid-gallery') ?> </a> </p>
	<?php 
}
