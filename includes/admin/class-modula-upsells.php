...
class Modula_Upsells {
	...
	public function filter_action_links( $links ) {
		...
		$upgrade = apply_filters( 'modula_upgrade_plugin_action', array(
				...
				'link'              => '<a  class="modula-lite-vs-pro" href="https://wp-modula.com/pricing/?utm_source=modula-lite&utm_medium=plugin_settings&utm_campaign=upsell">' . esc_html__( 'Upgrade to PRO!', 'modula-best-grid-gallery' ) . '</a>'
		) );
