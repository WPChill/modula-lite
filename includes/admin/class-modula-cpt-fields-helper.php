...
class Modula_CPT_Fields_Helper {
	...
	public static function get_defaults() {
		return apply_filters( 'modula_lite_default_settings', array(
			...
			'imageMessage'          => esc_html__( 'Here is the link to the image :', 'modula-best-grid-gallery' ),
			'galleryMessage'        => esc_html__( 'Here is the link to the gallery :', 'modula-best-grid-gallery' ),
			'enableWhatsapp'        => 0,
			'filterClick'           => 0,
