...
class Modula_CPT_Fields_Helper {
		...
		$fields = apply_filters( 'modula_gallery_fields', array(
			...
			'social' => array(
				...
				"emailSubject"   => array(
					...
					"description" => esc_html__( 'Email subject text, used in hover social sharing or Lightbox social sharing( PRO only )', 'modula-best-grid-gallery' ),
					'priority'    => 60,
				),
				"imageMessage"   => array(
					"name"        => esc_html__( 'Image link message', 'modula-best-grid-gallery' ),
					"type"        => "text",
					"default"     => esc_html__( 'Here is the link to the image :','modula-best-grid-gallery'),
					"description" => esc_html__( 'Text that is placed before the link of the image you want to share,used in hover social sharing or Lightbox social sharing( PRO only )', 'modula-best-grid-gallery' ),
					'priority'    => 61,
				),
				"galleryMessage" => array(
					"name"        => esc_html__( 'Gallery link message', 'modula-best-grid-gallery' ),
					"type"        => "text",
					"default"     => esc_html__( 'Here is the link to the gallery :','modula-best-grid-gallery' ),
					"description" => esc_html__( 'Text that is placed before the link of the gallery you want to share,used in hover social sharing or Lightbox social sharing( PRO only )', 'modula-best-grid-gallery' ),
					'priority'    => 62,
				),
			),
			'image-loaded-effects' => array(
	...
	public static function get_defaults() {
		return apply_filters( 'modula_lite_default_settings', array(
			...
			'enableWhatsapp'        => 0,
			'enableEmail'           => 0,
			'emailSubject'          => esc_html( 'Check out this awesome image !!' ),
			'imageMessage'          => esc_html( 'Here is the link to the image :' ),
			'galleryMessage'        => esc_html( 'Here is the link to the gallery :' ),
			'filterClick'           => 0,
