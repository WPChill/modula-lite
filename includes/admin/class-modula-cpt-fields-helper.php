		...
		$fields = apply_filters( 'modula_gallery_fields', array(
			...
			'social' => array(
				"enableSocial"   => array(
					...
					"type"        => "toggle",
					"default"     => 0,
					"description" => "Enable social sharing on hovering the gallery thumbnail. On by default.",
					'priority'    => 10,
				),
				"enableTwitter"   => array(
				...
				"emailSubject"   => array(
					...
					"type"        => "text",
					"default"     => esc_html( 'Check out this awesome image !!' ),
					"description" => esc_html__( 'Email subject text', 'modula-best-grid-gallery' ),
					'is_child'    => 'two',
					'priority'    => 40,
				),
				"imageMessage"   => array(
					...
					"type"        => "text",
					"default"     => esc_html( 'Here is the link to the image :'),
					"description" => esc_html__( 'Text that is placed before the link of the image you want to share.', 'modula-best-grid-gallery' ),
					'is_child'    => 'two',
					'priority'    => 40,
				),
				"galleryMessage" => array(
					...
					"type"        => "text",
					"default"     => esc_html( 'Here is the link to the gallery :' ),
					"description" => esc_html__( 'Text that is placed before the link of the gallery you want to share.', 'modula-best-grid-gallery' ),
					'is_child'    => 'two',
					'priority'    => 40,
				),
