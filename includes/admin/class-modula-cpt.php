...
class Modula_CPT {
	...
	public function register_cpt() {
		...
		$this->labels = apply_filters( 'modula_cpt_labels', array(
			...
			'not_found'             => '<a href="'.admin_url('post-new.php?post_type=modula-gallery').'">'.esc_html__( 'Add your first gallery ','modula-best-grid-gallery').'</a>'.esc_html__('now or check out our ','modula-best-grid-gallery'). '<a href="'.esc_url('https://modula.helpscoutdocs.com/').'">'.esc_html__('documentation ','modula-best-grid-gallery').'</a>'.esc_html__('if you need help figuring things out.', 'modula-best-grid-gallery' ),
