			...
			<div class="modula-upsells-carousel-wrapper-modal">
				<div class="modula-upsells-carousel-modal">
					<div class="modula-upsell-modal modula-upsell-item-modal">
						<h2><?php
							esc_html_e( 'Bulk Editor', 'modula-best-grid-gallery' ); ?></h2>
						<h4 class="modula-upsell-description-modal"><?php
							esc_html_e( 'Upgrade to a Pro plan and start editing multiple images from your gallery at the same time.', 'modula-best-grid-gallery' ); ?></h4>
						<ul class="modula-upsells-list-modal">
							<li><?php esc_html_e( 'Reduce the time required to set your gallery images information.', 'modula-best-grid-gallery' ); ?></li>
							<li><?php esc_html_e( 'You can edit the title, caption, alt text of your images.', 'modula-best-grid-gallery' ); ?></li>
							<li><?php esc_html_e( 'Set the filters for your images.', 'modula-best-grid-gallery' ); ?></li>
							<li><?php esc_html_e( 'Premium support.', 'modula-best-grid-gallery' ); ?></li>
						</ul>
						<p>
							<?php
							...
							echo apply_filters( 'modula_upsell_buttons', $buttons, 'bulk_editor' );
