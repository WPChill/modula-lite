...
$delete_old_tables = isset($uninstall_options['delete_old_tables']) ? $uninstall_options['delete_old_tables'] : false;
?>
<div class="row">
    ...
    <form id="modula_uninstall_option" method="post">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th  scope="row" valign="top">
                    <?php echo __('Delete old tables set by Modula Gallery plugin versions 1.x','modula-best-grid-gallery'); ?>
                </th>
                <td>
                    <div class="wrap modula">
                        <div class="">
                            <div class="modula-toggle">
                                <input class="modula-toggle__input" type="checkbox"
                                       data-setting="modula_uninstall_option[delete_old_tables]"
                                       id="modula_uninstall_option[delete_old_tables]" name="modula_uninstall_option[delete_old_tables]"
                                       value="1" <?php echo checked('1', $delete_old_tables, false); ?>>
                                <div class="modula-toggle__items">
                                    <span class="modula-toggle__track"></span>
                                    <span class="modula-toggle__thumb"></span>
                                    <svg class="modula-toggle__off" width="6" height="6" aria-hidden="true" role="img"
