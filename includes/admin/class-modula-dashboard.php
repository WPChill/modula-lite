...
class Modula_Dashboard {
	...
	public function __construct() {
        ...
        $this->tabs = apply_filters(
			...
			array(
                ...
                //'troubleshoot' => array( 'name' =>__( 'Troubleshooting', 'modula-best-grid-gallery' ), 'url' => false ),
                'extensions'   => array( 'name' =>__( 'Extensions', 'modula-best-grid-gallery' ), 'url' => admin_url( 'edit.php?post_type=modula-gallery&page=modula-addons' ) ),
                'lite_vs_pro'  => array( 'name' =>__( 'Lite vs. Pro', 'modula-best-grid-gallery' ), 'url' => admin_url( 'edit.php?post_type=modula-gallery&page=modula-lite-vs-pro' ) ),
			)
		);
        ...
        add_filter( 'modula_admin_page_link', array( $this, 'add_dashboard_menu_item' ), 99, 1 );

        // Clear all notices
        add_action('in_admin_header', array( $this, 'clear_admin_notices' ), 99);

        // Show Modula header on dashboard
        add_filter( 'modula_page_header', array( $this, 'is_dashboard' ) );
	...
	public function on_activate_redirect( $version, $upgrade, $first_install ) {
		...
		if ( $first_install || $upgrade ) {
			add_action( 'activated_plugin', array( $this, 'modula_dashboard_redirect' ) );
		}
	}
    
    public function modula_cpt_to_menu( $args ){
        $args['show_in_menu'] = $this->menu_slug;
	 ...
	 * @since 2.7.5
	 */
	public function modula_dashboard_redirect( $plugin ) {
	 ...
	 * @since 2.3.4
	 */
	public function add_dashboard_menu_item( $links ) {

		$links[] = array(
			'page_title' => esc_html__( 'Dashboard', 'modula-best-grid-gallery' ),
			'menu_title' => esc_html__( 'Dashboard', 'modula-best-grid-gallery' ),
			'capability' => 'manage_options',
			'menu_slug'  => $this->menu_slug,
			'function'   => array( $this, 'dashboard_view' ),
			'priority'   => 0,
		);
    ...
    public function generate_tab_url( $slug ){
        if( isset( $this->tabs[ $slug ] ) ){
            if( $this->tabs[ $slug ][ 'url' ] ){
                ...
                return admin_url('edit.php?post_type=modula-gallery&page=' . $this->menu_slug . '&tab='. $slug );
            }
        }
    }
    ...
    public function render_content(){
		...
		switch ( $active ) {
            ...
            case 'troubleshoot':
                ...
                break;
			default:
				do_action( "modula_dashboard_tab_{$active}" );
				break;
		}
    ...
    ?>
        <div class="wpchill_dashboard_content_wrap" >
            <p class="wpchill_dashboard_default_text"> <?php esc_html_e( 'Thank you for installing Modula. Here are some usefull resources that will help you get started with our plugins: ', 'modula-best-grid-gallery' ); ?> </p>
            <div class="wpchill_dashboard_grid_4" >
                <div class="wpchill_dashboard_item wpchill_card" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/background-box.png';?>);">
                   <div> <img src="<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/icons8-book-shelf-96.png';?>" class="wpchill_dashboard_item_icon"/>
                    <h3 class="wpchill_dashboard_item_title"> <?php esc_html_e( 'Documentation', 'modula-best-grid-gallery' ); ?> </h3></div>
                    ...
                    <a href="https://modula.helpscoutdocs.com/" target="_BLANK" class="wpchill_dashboard_item_button" style="color: #fff; background-color: #33a370;"> <?php esc_html_e( 'Read Documentation', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a>
                </div>
                <div class="wpchill_dashboard_item wpchill_card" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/background-box.png';?>);">
                <div>  <img src="<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/icons8-services-96.png';?>" class="wpchill_dashboard_item_icon"/>
                    <h3 class="wpchill_dashboard_item_title"> <?php esc_html_e( 'Settings', 'modula-best-grid-gallery' ); ?> </h3></div>
                    <p class="wpchill_dashboard_item_text"> <?php esc_html_e( 'Dig deeper into what Modula can do for you.', 'modula-best-grid-gallery' ); ?> </p>
                    <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=modula-gallery&page=modula' ) ); ?>" class="wpchill_dashboard_item_button" style="color: #fff; background-color: #33a370;"> <?php esc_html_e( 'View Modula Settings', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a>
                </div>
                <div class="wpchill_dashboard_item wpchill_card" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/background-box.png';?>);">
                <div>  <img src="<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/icons8-galleries-96.png';?>" class="wpchill_dashboard_item_icon"/>
                    <h3 class="wpchill_dashboard_item_title"> <?php esc_html_e( 'Galleries', 'modula-best-grid-gallery' ); ?> </h3></div>
                    <p class="wpchill_dashboard_item_text"> <?php echo wp_kses_post( __( 'Add your first gallery now. <br> Let\'s build your awesome gallery.', 'modula-best-grid-gallery' ) ); ?> </p>
                    <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=modula-gallery' ) ); ?>" class="wpchill_dashboard_item_button" style="color: #fff; background-color: #33a370;"> <?php esc_html_e( 'View Galleries', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a>
                </div>
                <div class="wpchill_dashboard_item wpchill_card" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/background-box.png';?>);">
                <div>   <img src="<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/icons8-extensions-96.png';?>" class="wpchill_dashboard_item_icon"/>
                    <h3 class="wpchill_dashboard_item_title"> <?php esc_html_e( 'Extensions', 'modula-best-grid-gallery' ); ?> </h3></div>
                    ...
                    <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=modula-gallery&page=modula-addons' ) ); ?>" class="wpchill_dashboard_item_button" style="color: #fff; background-color: #33a370;"> <?php esc_html_e( 'View Modula Extensions', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a>
                </div>
            </div>

            <!-- Common use cases -->
            <div class="wpchill_card wpchill_dashboard_use_cases_wrap" >
                <h3 class="wpchill_dashboard_item_title"><span class="wpchill_dashboard_item_icon" style="background-color: #3858e9;color: #fff;">?</span><?php esc_html_e( 'Common Use Cases', 'modula-best-grid-gallery' ); ?> </h3>
                <div class="wpchill_dashboard_grid_2">
                    <div  id="wpchill_use_cases_block" class="wpchill_dashboard_use_cases">
                        <!-- Populated from dashboard.js -->
                    </div>
                </div>
            </div>

             <!-- Call to action/upsell -->
            <div class="wpchill_dashboard_cta_wrap" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/banner-upsell.png';?>);">
                <div class="wpchill_dashboard_cta_left">
                    <h2 class="wpchill_dashboard_cta_title"> <span class="wpchill_dashboard_icon" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/icons8-lock-48.png';?>);"></span><?php esc_html_e( 'Unlock all features of Modula', 'modula-best-grid-gallery' ); ?> </h2>
                    <p class="wpchill_dashboard_default_text"> <?php esc_html_e( 'Thank you for installing Modula. Here are some usefull resources that will help you get started with our plugins: ', 'modula-best-grid-gallery' ); ?> </p>
                </div>
                <div class="wpchill_dashboard_cta_right">
                    <a href="https://wp-modula.com/pricing/?utm_source=modula-lite&utm_medium=dashboard-page&utm_campaign=upsell" target="_BLANK" class="wpchill_dashboard_item_button" style="color: #fff; background-color: #33a370;"> <?php esc_html_e( 'Get Modula Pro', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a>
                </div>
            </div>
            <div class="wpchill_dashboard_late_change">
                <!-- Latest from the blog -->
                <div class="wpchill_card wpchill_dashboard_latest_wrap">
                    <h3 class="wpchill_dashboard_item_title"><span class="wpchill_dashboard_icon_blog" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/icons8-help-48.png';?>);"></span><?php esc_html_e( 'Latest from the blog', 'modula-best-grid-gallery' ); ?> </h3>

                    <?php $this->_render_rss_feed(); ?>
                    <a href="https://wp-modula.com/blog/" target="_BLANK" class="wpchill_dashboard_item_button" style="color: #fff; background-color: #33a370; margin-left: 30px;"> <?php esc_html_e( 'Read the blog', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a>
                </div>

                <!-- Changelog -->
                <div class="wpchill_card wpchill_dashboard_changelog_wrap">
                    <h3 class="wpchill_dashboard_item_title"><span class="wpchill_dashboard_icon_blog" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/icons8-changelog-48.png';?>);"></span><?php esc_html_e( 'Changelog', 'modula-best-grid-gallery' ); ?> </h3>
                    <?php $this->_render_changelog(); ?>
                    <a href="<?php echo MODULA_URL . "changelog.txt"; ?>" target="_BLANK" class="wpchill_dashboard_item_button" style="color: #33a370; background-color: #fff; border-color: #33a370;float:right; margin-left: 30px;"> <?php esc_html_e( 'View full changelog', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a>
    ...
    <div class="wpchill_dashboard_content_wrap" >
        ...
        <!-- About Us -->
        <div class="wpchill_dashboard_about_us" style="background-image:url(<?php echo esc_url( MODULA_URL ) .'assets/images/dashboard/header-bg-2.png';?>);">
        ...
        <div class="wpchill_dashboard_about_button" > <a href="https://wpchill.com/about/" target="_BLANK" class="wpchill_dashboard_item_button" style="color: #fff; background-color: #33a370; margin-left: 30px;"> <?php esc_html_e( 'Find more about us', 'modula-best-grid-gallery' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span> </a> </div>
    ...
    public function _render_changelog(){
        $changelog = MODULA_PATH . "changelog.txt" ;
	...
	public function render_partners() {
        ...
        $data = get_transient( 'modula_all_partners' );

        if ( false == $data ){

            $addons = array();

            $url = 'https://wp-modula.com/parteners.json';
		...
		if ( ! empty( $addons ) ) {
            ...
            $modula_addons = new Modula_Addons();
			foreach ( $addons as $addon ) {

				$modula_addons->render_addon_top( $addon, $addons_images );
...
<?php
    ...
    */
    ...
    public function enqueue_scripts(){
        ...
        wp_enqueue_style( 'modula-dashboard-style', MODULA_URL . 'assets/css/admin/dashboard.css', null, MODULA_LITE_VERSION );
    
        wp_enqueue_script( 'modula-dashboard', MODULA_URL . 'assets/js/admin/dashboard.js', array( 'jquery', 'updates' ), MODULA_LITE_VERSION, true );
        wp_add_inline_script( 'modula-dashboard', 'const modula_common_use_cases = ' . $this->get_dashboard_data(), 'before' );
    }
