...
/* harmony export */ });
/* harmony import */ var _images_modula_logo_black_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./images/modula-logo-black.png */ "./apps/notification-system/images/modula-logo-black.png");
...
function NotificationIcon(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    src: _images_modula_logo_black_png__WEBPACK_IMPORTED_MODULE_0__,
...
function NotificationActions(_ref) {
  ...
  var handleClick = function handleClick(action, id) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, _extends({
      key: index,
      className: action["class"] || 'notification-action'
    }, action.url ? {
      href: he__WEBPACK_IMPORTED_MODULE_2___default().decode(action.url)
    } : {}, action.id ? {
      id: action.id
    } : {}, {
      target: action.target || '',
      text: he__WEBPACK_IMPORTED_MODULE_2___default().decode(action.label || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Action', 'modula-best-grid-gallery')),
      variant: action.variant || 'secondary',
      size: action.size || 'small',
      onClick: function onClick() {
        return handleClick(action, id);
      }
    }));
  }));
}
...
/* harmony import */ var _state_use_modula_state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../state/use-modula-state */ "./apps/notification-system/state/use-modula-state.js");
/* harmony import */ var _state_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../state/actions */ "./apps/notification-system/state/actions.js");
...
function NotificationsList() {
  ...
  var _useModulaState = (0,_state_use_modula_state__WEBPACK_IMPORTED_MODULE_5__.useModulaState)(),
    state = _useModulaState.state,
    dispatch = _useModulaState.dispatch;
  var visibleNotifications = state.visibleNotifications,
  ...
  var dismissNotification = function dismissNotification(id) {
    ...
    (0,_state_actions__WEBPACK_IMPORTED_MODULE_6__.setVisibleNotifications)(function (prevNotifications) {
  ...
  var handleTogglePanel = function handleTogglePanel(id) {
    dispatch((0,_state_actions__WEBPACK_IMPORTED_MODULE_6__.setOpenPanels)([].concat(_toConsumableArray(openPanels), [id])));
  };
  return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Panel, null, (visibleNotifications === null || visibleNotifications === void 0 ? void 0 : visibleNotifications.length) === 0 && /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
      ...
      onToggle: function onToggle() {
        return handleTogglePanel(notification.id);
      }
      ...
      variant: "muted"
    }, /*#__PURE__*/React.createElement(interweave__WEBPACK_IMPORTED_MODULE_8__.Markup, {
...
function NotificationsContainer() {
  ...
  }, /*#__PURE__*/React.createElement(_notification_notifications_head__WEBPACK_IMPORTED_MODULE_2__.NotificationsHead, null)), /*#__PURE__*/React.createElement(_notification_notifications_list__WEBPACK_IMPORTED_MODULE_1__.NotificationsList, null), /*#__PURE__*/React.createElement("div", {
...
/* harmony import */ var _notifications_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./notifications-container */ "./apps/notification-system/notifications-container.jsx");
...
/* harmony import */ var _state_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./state/actions */ "./apps/notification-system/state/actions.js");
...
function Notifications() {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(function () {
    if (!isLoading && data) {
      var allNotifications = Object.values(data).flat();
      dispatch((0,_state_actions__WEBPACK_IMPORTED_MODULE_5__.setVisibleNotifications)(allNotifications));
    }
  }, [data, isLoading, dispatch]);
  if (0 === state.visibleNotifications.length || closedBubble) {
    return null;
  }
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_notification_icon__WEBPACK_IMPORTED_MODULE_0__.NotificationIcon, null), showContainer && /*#__PURE__*/React.createElement(_notifications_container__WEBPACK_IMPORTED_MODULE_1__.NotificationsContainer, null));
}
...
var queryClient = new _tanstack_react_query__WEBPACK_IMPORTED_MODULE_0__.QueryClient({
  defaultOptions: {
    queries: {
      retry: function retry(failureCount) {
...
var dismissNotice = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var id, permanent, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          id = _ref.id, permanent = _ref.permanent;
          _context.next = 3;
          return _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
            path: "/modula/v1/notifications/".concat(id || ''),
            method: 'DELETE',
            data: {
              permanent: permanent
            }
...
var useNotificationQuery = function useNotificationQuery() {
  return (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_1__.useQuery)({
    ...
    refetchInterval: function refetchInterval(query) {
      var _query$state;
      return (query === null || query === void 0 || (_query$state = query.state) === null || _query$state === void 0 ? void 0 : _query$state.fetchFailureCount) < 5 ? 5000 : false;
    }
  });
};
...
/* harmony export */   setOpenPanels: () => (/* binding */ setOpenPanels),
/* harmony export */   setShowContainer: () => (/* binding */ setShowContainer),
/* harmony export */   setVisibleNotifications: () => (/* binding */ setVisibleNotifications)
/* harmony export */ });
...
var setOpenPanels = function setOpenPanels(state) {
  return {
    type: 'SET_OPEN_PANELS',
    payload: state
  };
};
var setVisibleNotifications = function setVisibleNotifications(state) {
  return {
...
function reducer(state, action) {
  switch (action.type) {
    ...
    case 'SET_VISIBLE_NOTIFICATIONS':
      return _objectSpread(_objectSpread({}, state), {}, {
        visibleNotifications: action.payload
      });
    default:
      return state;
  }
...
/***/ "./apps/notification-system/images/modula-logo-black.png":
/*!***************************************************************!*\
  !*** ./apps/notification-system/images/modula-logo-black.png ***!
  \***************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "images/modula-logo-black.787b3c84.png";
