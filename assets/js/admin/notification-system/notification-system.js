...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@tanstack/query-core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _QueryClientProvider_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./QueryClientProvider.js */ "./node_modules/@tanstack/react-query/build/modern/QueryClientProvider.js");
...
/* harmony import */ var _errorBoundaryUtils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./errorBoundaryUtils.js */ "./node_modules/@tanstack/react-query/build/modern/errorBoundaryUtils.js");
/* harmony import */ var _isRestoring_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./isRestoring.js */ "./node_modules/@tanstack/react-query/build/modern/isRestoring.js");
/* harmony import */ var _suspense_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./suspense.js */ "./node_modules/@tanstack/react-query/build/modern/suspense.js");
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  const isRestoring = (0,_isRestoring_js__WEBPACK_IMPORTED_MODULE_5__.useIsRestoring)();
  ...
  (0,_suspense_js__WEBPACK_IMPORTED_MODULE_6__.ensureSuspenseTimers)(defaultedOptions);
  (0,_errorBoundaryUtils_js__WEBPACK_IMPORTED_MODULE_4__.ensurePreventErrorBoundaryRetry)(defaultedOptions, errorResetBoundary);
  (0,_errorBoundaryUtils_js__WEBPACK_IMPORTED_MODULE_4__.useClearResetErrorBoundary)(errorResetBoundary);
  ...
  react__WEBPACK_IMPORTED_MODULE_0__.useSyncExternalStore(
    react__WEBPACK_IMPORTED_MODULE_0__.useCallback(
      (onStoreChange) => {
        const unsubscribe = isRestoring ? () => void 0 : observer.subscribe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@tanstack/query-core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).batchCalls(onStoreChange));
  ...
  if ((0,_suspense_js__WEBPACK_IMPORTED_MODULE_6__.shouldSuspend)(defaultedOptions, result)) {
    throw (0,_suspense_js__WEBPACK_IMPORTED_MODULE_6__.fetchOptimistic)(defaultedOptions, observer, errorResetBoundary);
  }
  if ((0,_errorBoundaryUtils_js__WEBPACK_IMPORTED_MODULE_4__.getHasError)({
    result,
    errorResetBoundary,
  ...
  if (defaultedOptions.experimental_prefetchInRender && !Object(function webpackMissingModule() { var e = new Error("Cannot find module '@tanstack/query-core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) && (0,_suspense_js__WEBPACK_IMPORTED_MODULE_6__.willFetch)(result, isRestoring)) {
    const promise = isNewCacheEntry ? (
      // Fetch immediately on render in order to ensure `.promise` is resolved even if the component is unmounted
      (0,_suspense_js__WEBPACK_IMPORTED_MODULE_6__.fetchOptimistic)(defaultedOptions, observer, errorResetBoundary)
    ) : (
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@tanstack/query-core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _QueryClientProvider_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./QueryClientProvider.js */ "./node_modules/@tanstack/react-query/build/modern/QueryClientProvider.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@tanstack/react-query/build/modern/utils.js");
"use client";
...
function useMutation(options, queryClient) {
  const client = (0,_QueryClientProvider_js__WEBPACK_IMPORTED_MODULE_2__.useQueryClient)(queryClient);
  const [observer] = react__WEBPACK_IMPORTED_MODULE_0__.useState(
    () => new Object(function webpackMissingModule() { var e = new Error("Cannot find module '@tanstack/query-core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(
      client,
      options
    )
  );
  ...
  const result = react__WEBPACK_IMPORTED_MODULE_0__.useSyncExternalStore(
    react__WEBPACK_IMPORTED_MODULE_0__.useCallback(
      (onStoreChange) => observer.subscribe(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@tanstack/query-core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).batchCalls(onStoreChange)),
      [observer]
    ),
    () => observer.getCurrentResult(),
    () => observer.getCurrentResult()
  ...
  const mutate = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(
    (variables, mutateOptions) => {
      observer.mutate(variables, mutateOptions).catch(_utils_js__WEBPACK_IMPORTED_MODULE_3__.noop);
    },
    [observer]
  );
  if (result.error && (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.shouldThrowError)(observer.options.throwOnError, [result.error])) {
    throw result.error;
  }
...
function useQuery(options, queryClient) {
  return (0,_useBaseQuery_js__WEBPACK_IMPORTED_MODULE_1__.useBaseQuery)(options, Object(function webpackMissingModule() { var e = new Error("Cannot find module '@tanstack/query-core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), queryClient);
}
...
/***/ "./apps/notification-system/notification-close.jsx":
/*!*********************************************************!*\
  !*** ./apps/notification-system/notification-close.jsx ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NotificationClose: () => (/* binding */ NotificationClose)
/* harmony export */ });
/* harmony import */ var _state_use_modula_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./state/use-modula-state */ "./apps/notification-system/state/use-modula-state.js");
/* harmony import */ var _state_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./state/actions */ "./apps/notification-system/state/actions.js");
...
function NotificationClose() {
  var _useModulaState = (0,_state_use_modula_state__WEBPACK_IMPORTED_MODULE_0__.useModulaState)(),
    dispatch = _useModulaState.dispatch;
  var handleCloseClick = function handleCloseClick() {
    dispatch((0,_state_actions__WEBPACK_IMPORTED_MODULE_1__.setClosedBubble)(true));
  };
  return /*#__PURE__*/React.createElement("button", {
    className: "bullet close",
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Close Notification', 'modula-best-grid-gallery'),
...
/***/ "./apps/notification-system/notification-icon.jsx":
/*!********************************************************!*\
  !*** ./apps/notification-system/notification-icon.jsx ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function NotificationIcon(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    src: _assets_images_logo_dark_png__WEBPACK_IMPORTED_MODULE_0__,
    className: "notification-icon-img",
    alt: "Modula Logo"
  }), Object.entries(notifications).map(function (_ref2) {
...
/* harmony export */ });
/* harmony import */ var _notification_notifications_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notification/notifications-list */ "./apps/notification-system/notification/notifications-list.jsx");
/* harmony import */ var _notification_notifications_head__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./notification/notifications-head */ "./apps/notification-system/notification/notifications-head.jsx");
/* harmony import */ var _notification_notifications_footer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./notification/notifications-footer */ "./apps/notification-system/notification/notifications-footer.jsx");
...
function NotificationsContainer(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(_notification_notifications_head__WEBPACK_IMPORTED_MODULE_1__.NotificationsHead, null)), /*#__PURE__*/React.createElement(_notification_notifications_list__WEBPACK_IMPORTED_MODULE_0__.NotificationsList, {
    notifications: notifications
  }), /*#__PURE__*/React.createElement("div", {
    className: "notification-footer"
  }, /*#__PURE__*/React.createElement(_notification_notifications_footer__WEBPACK_IMPORTED_MODULE_2__.NotificationsFooter, null)));
}

/***/ }),

/***/ "./apps/notification-system/notifications.jsx":
/*!****************************************************!*\
  !*** ./apps/notification-system/notifications.jsx ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./apps/notification-system/query/client.js":
/*!**************************************************!*\
  !*** ./apps/notification-system/query/client.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @tanstack/react-query */ "./node_modules/@tanstack/react-query/build/modern/types.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useNotificationQuery: () => (/* binding */ useNotificationQuery)
/* harmony export */ });
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__);
...
var useNotificationQuery = function useNotificationQuery() {
...
/***/ "./apps/notification-system/state/default-state.js":
/*!*********************************************************!*\
  !*** ./apps/notification-system/state/default-state.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./apps/notification-system/state/reducer.js":
/*!***************************************************!*\
  !*** ./apps/notification-system/state/reducer.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./apps/notification-system/state/state.js":
/*!*************************************************!*\
  !*** ./apps/notification-system/state/state.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reducer */ "./apps/notification-system/state/reducer.js");
/* harmony import */ var _default_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./default-state */ "./apps/notification-system/state/default-state.js");
/* harmony import */ var _use_modula_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./use-modula-state */ "./apps/notification-system/state/use-modula-state.js");
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
function StateProvider(_ref) {
  var children = _ref.children,
    galleryId = _ref.galleryId;
  var _useReducer = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useReducer)(_reducer__WEBPACK_IMPORTED_MODULE_1__["default"], (0,_default_state__WEBPACK_IMPORTED_MODULE_2__.initialState)(galleryId)),
    _useReducer2 = _slicedToArray(_useReducer, 2),
    state = _useReducer2[0],
    dispatch = _useReducer2[1];
  return /*#__PURE__*/React.createElement(_use_modula_state__WEBPACK_IMPORTED_MODULE_3__.StateContext.Provider, {
    value: {
      state: state,
      dispatch: dispatch
    }
...
/***/ "./apps/notification-system/state/use-modula-state.js":
/*!************************************************************!*\
  !*** ./apps/notification-system/state/use-modula-state.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var StateContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createContext)();
function useModulaState() {
  var context = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useContext)(StateContext);
  if (!context) {
...
/***/ "./apps/notification-system/index.scss":
/*!*********************************************!*\
  !*** ./apps/notification-system/index.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "images/logo-dark.6f737e75.png";
...
"use strict";
/*!*******************************************!*\
  !*** ./apps/notification-system/index.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.scss */ "./apps/notification-system/index.scss");
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @tanstack/react-query */ "./node_modules/@tanstack/react-query/build/modern/QueryClientProvider.js");
/* harmony import */ var _query_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./query/client */ "./apps/notification-system/query/client.js");
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./notifications */ "./apps/notification-system/notifications.jsx");
/* harmony import */ var _state_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./state/state */ "./apps/notification-system/state/state.js");
...
document.addEventListener('DOMContentLoaded', function () {
  var postsContainer = document.getElementById('wpwrap');
  if (postsContainer) {
    ...
    var root = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.createRoot)(document.getElementById('modula-notifications-root'));
    root.render(/*#__PURE__*/React.createElement(_tanstack_react_query__WEBPACK_IMPORTED_MODULE_5__.QueryClientProvider, {
      client: _query_client__WEBPACK_IMPORTED_MODULE_1__.queryClient
    }, /*#__PURE__*/React.createElement(_state_state__WEBPACK_IMPORTED_MODULE_3__.StateProvider, null, /*#__PURE__*/React.createElement(_notifications__WEBPACK_IMPORTED_MODULE_2__.Notifications, null))));
  }
});
})();
