!(function (e) {
  ...
  e(document).ready(function () {
    e(
      ...
      e(".modula-feedback-notice .notice-dismiss").click(function (l) {
        l.preventDefault();
        var o = e(this).parent();
        e.ajax({
          method: "POST",
      ...
      e(".copy-modula-shortcode").click(function (l) {
        l.preventDefault();
        var o = e(this).parent().find("input");
        o.focus(),
          o.select(),
          document.execCommand("copy"),
          e(this).next("span").text("Shortcode copied"),
          e(".copy-modula-shortcode")
            .not(e(this))
            .parent()
            .find("span")
            .text("");
      ...
      e("body").on(
        ...
        function (l) {
          l.preventDefault();
          var o = e(this).parent(),
            a = { action: "modula_lbu_notice", nonce: modulaHelper._wpnonce };
          e.post(modulaHelper.ajax_url, a, function (e) {
            o.remove();
          });
        }
      );
  ...
  const l = (l) => {
      l.preventDefault();
      const a = l.data.upsell;
      e.get(
        modulaHelper.ajax_url,
        { action: "modula_modal-" + a + "_upgrade" },
        (l) => {
          e("body").addClass("modal-open"),
            e("body").append(l),
            e(document).one(
              "click",
              ".modula-modal__overlay." + a,
              { upsell: a },
              o
            ),
            e(document).one(
              "click",
              ".modula-modal__dismiss." + a,
              { upsell: a },
              o
            );
        }
    ...
    o = (l) => {
      const o = l.data.upsell;
      e(".modula-modal__overlay." + o).remove(),
  ...
  e("body").on(
    ...
    jQuery(window).on("load", function () {
      ...
      e.has("page") &&
        "modula-lite-vs-pro" === e.get("page") &&
        e.has("extension") &&
        jQuery("html,body").animate(
          {
            scrollTop:
              jQuery(".wpchill-plans-table.wpchill-highlight").offset().top -
              150
          },
          600
        );
  ...
  const a = () => {
    const e = document.getElementById("side-sortables"),
      l = document.getElementById("submitdiv");
    if (!l || !e) return;
    const o = l.offsetTop + 100,
      a = "is-sticky";
    window.scrollY >= o ? e.classList.add(a) : e.classList.remove(a);
  };
