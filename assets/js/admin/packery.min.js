!(function (e, i) {
			...
			if (
				((function () {
					if (!E) {
						...
						e.appendChild(t);
						var i = x(t);
						(T.isBoxSizeOuter = b = 200 == y(i.width)),
							e.removeChild(t);
					}
				})(),
				...
				var h = i.paddingLeft + i.paddingRight,
					...
					p = n && b,
					g = y(e.width);
				!1 !== g && (i.width = g + (p ? 0 : h + l));
				var m = y(e.height);
				return (
					!1 !== m && (i.height = m + (p ? 0 : u + f)),
	...
	(function (t, e) {
	...
	})(window, function (c, t, g, e, i) {
		'use strict';
		g.prototype.canFit = function (t) {
		...
		(o._create = function () {
			...
			(o.updateShiftTargets = function (t) {
				...
				var h,
					u = this._getOption('horizontal'),
					e = u ? 'rowHeight' : 'columnWidth',
					c = u ? 'height' : 'width';
				...
				f.forEach(function (t) {
					...
					var i = u ? e.x + e.width : e.x,
						n = u ? e.y : e.y + e.height;
